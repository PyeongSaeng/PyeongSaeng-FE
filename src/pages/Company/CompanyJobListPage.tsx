      ...
      <Topbar>
        <div className="w-full h-full">
          ...
          <div className="mt-[17px] flex flex-col items-center">
            <p className="text-[20px] font-semibold text-[#747474]">신청서 입력</p>
          ...
          {step === 0 && (
            <div className="flex flex-col items-center">
              ...
              >
                <img src="/icons/plus_icon.svg" alt="추가" className="w-[24px] h-[24px]" />
                새 신청서 추가
              </button>
                ...
                {jobs.map((job, index) => (
                  <div key={job.id} className="mt-[31px] flex flex-col items-center">
                    ...
                    <div className="w-full flex gap-[13px] mt-[16px] items-center justify-center">
                      ...
                      >
                        {deleting && deletingId === job.id ? "삭제 중…" : "삭제"}
                      </button>
          ...
          {step === 2 && (
            <CompanyCreateFormPage
              draft={draft}
              onBack={() => setStep(1)}
              onChangeFormFields={(list: JobPostFormField[]) =>
