...
const ToggleButton = () => {
  ...
  const goToPersonalVersion = () => setToggleVersion('personal');
  const goToCompanyVersion = () => setToggleVersion('company');

  return (
    <div className="flex flex-row items-center">
      <div
        className={clsx(
          'flex items-center justify-center relative w-[80.61px] h-[28px] rounded-[16px] outline outline-[1px] outline-[#D3D3D3] bg-[#F5F5F5]'
        )}
      >
        <div
          className={clsx(
